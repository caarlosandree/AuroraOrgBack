...
@Schema(description = "Resposta detalhada de uma categoria de chamado")
public record CategoriaDetalheResponse(
    ...
    @Schema(description = "Quantidade de chamados com esta categoria")
    Long totalChamados,
